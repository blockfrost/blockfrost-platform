...
- New endpoints proxied to the data node: `/accounts/{stake_address}/utxos`, `/accounts/{stake_address}/transactions`, `/addresses/{address}`, `/addresses/{address}/total`, `/blocks/slot/{slot_number}`, `/pools/retiring`, `/pools/{pool_id}/relays`, `/blocks/{hash_or_number}/txs/cbor`, and `/blocks/latest/txs/cbor`
