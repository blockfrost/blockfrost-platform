...
impl Dolos {
    ...
    pub async fn txs_hash_mirs(&self, hash: &str) -> ApiResult<Vec<TxContentMirsInner>> {
    ...
    pub async fn txs_hash_stakes(&self, hash: &str) -> ApiResult<Vec<TxContentStakeAddrInner>> {
