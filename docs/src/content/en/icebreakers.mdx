...
Come talk to us on [Discord](https://discord.gg/YfGKvqpt2d) in the `#ask-blockfrost` channel.
...
2. The `blockfrost-platform` API remains as-is on port 3000, but it no longer needs to be open to the public: all Blockfrost traffic arrives over the outbound WebSocket connection to the load balancers.
