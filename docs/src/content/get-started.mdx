...
<Callout>
  To serve blockchain query endpoints (blocks, transactions, accounts, etc.), you will also need a running [Dolos](https://github.com/txpipe/dolos) data node.
  See the [Data node](/data-node) section for details.
</Callout>
